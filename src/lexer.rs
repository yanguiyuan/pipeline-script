...
impl TokenStream{
    ...
    pub fn next(&mut self)->(Token,Position){
        ...
        return self.tokenizer.next().unwrap_or((Token::EOF,Position::none()))
    }
    #[allow(unused)]
    pub fn peek(&mut self)->(Token,Position){
        ...
        self.peek=o.clone();
        return o.unwrap_or((Token::EOF,Position::none()))
    }
}
...
impl Lexer{
    ...
    fn with_pos(&self,span:usize)->Position{
        return Position::new(self.index,span,self.row,self.col,&self.module_name)
    }
