...
use std::ptr;
use std::sync::Arc;
use llvm_sys::core::{LLVMAddFunction, LLVMAddGlobal, LLVMAppendBasicBlock, LLVMCreateBuilder, LLVMDisposeModule, LLVMDumpModule, LLVMGetNamedFunction, LLVMModuleCreateWithName, LLVMPositionBuilderAtEnd, LLVMSetInitializer, LLVMTypeOf};
...
impl LLVMModule{
    ...
    pub fn create_executor(&self) -> Result<JITExecutor,String> {
        ...
        Ok(JITExecutor::new(self.module_ref.clone(),engine,self.function_map.clone()))
    }
